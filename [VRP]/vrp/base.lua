...
function vRP.ban(adminsource,permid,time,reason)
    ...
    if getBannedPlayerSrc then 
        if tonumber(time) then 
            ...
            vRP.kick(getBannedPlayerSrc,"You Are Banned From LGN | Your ban expires in: " .. os.date("%c", banTime) .. " Reason: " .. reason .. " | Admin: " ..  GetPlayerName(adminsource) .. " | ID Of Admin: " .. adminPermID ) 
            ...
            vRP.kick(getBannedPlayerSrc,"You Have Been Permanently Banned From LGN." .. " Reason: " .. reason .. " | Banning Admin: " ..  GetPlayerName(adminsource) .. " | ID Of Admin: " .. adminPermID ) 
        end
    else 
        if tonumber(time) then 
            local banTime = os.time()
